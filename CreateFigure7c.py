"""Create Figure 7a (lower panel) of the paper"""
...
Quality = 1000  # Radius of star in pixels --> size of numerical sampling grid
...
plt.savefig("fig_7c.pdf", bbox_inches='tight')
